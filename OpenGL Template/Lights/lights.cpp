...
char vertex_shader[] = "Lights/shader.vs";
char fragment_shader[] = "Lights/shader.fs";
char light_fragment_shader[] = "Lights/lshader.fs";
char diffuse_texture_path[] = "Lights/container2.png";
char specular_texture_path[] = "Lights/container2_specular.png";
...
LightsShader::LightsShader(const GLchar* vp, const GLchar* fp) : Shader(vp, fp) {};
LightsShader::~LightsShader() {};

LightsRender::LightsRender(int w, int h) : width(w), height(h) {
    shader = LightsShader(vertex_shader, fragment_shader);
    light_shader = LightsShader(vertex_shader, light_fragment_shader);
};
...
void LightsRender::run(GLFWwindow* window) {
